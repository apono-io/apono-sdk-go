...
func (o *CreateIntegration) GetCustomAccessDetails() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CreateIntegration) GetCustomAccessDetailsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateIntegration) HasCustomAccessDetails() bool {
...
func (o *CreateIntegration) UnsetCustomAccessDetails() {
