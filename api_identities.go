...
func (r ApiListIdentitiesRequest) Execute() (*PaginatedResponseIdentityModelV2, *http.Response, error) {
...
func (a *IdentitiesApiService) ListIdentitiesExecute(r ApiListIdentitiesRequest) (*PaginatedResponseIdentityModelV2, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *PaginatedResponseIdentityModelV2
	)
	...
	localVarPath := localBasePath + "/api/v2/identities"
